...
function buildSimpleConfig(inFilePath, outFilePath,  params) {
  return new Promise(function(resolve, reject) {
    ...
    if (!resolution) {
      console.log("Unknown resolution specified: '%s', defaulting to 'standard'", params.resolution);
    ...
    console.log("Calculated infill_line_width = %f (resolution = %f, infillLineWidthMultiplier = %f)",
    ...
    if (infill_sparse_density === null) {
      console.log("Unknown infill specified: '%s', defaulting to 'standard'", params.infill);
      infill_sparse_density = infillConfig.standard;
    }
    console.log("infill_sparse_density = %d", infill_sparse_density);
    ...
    console.log("Calculated infill_line_distance = %f", jsonConfig.overrides.infill_line_distance.default_value);
    ...
    console.log("Print support: %s", jsonConfig.overrides.support_enable.default_value);
